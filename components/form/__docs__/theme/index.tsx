                        ...
                        <Demo title="Form Inline">
                            <DemoGroup label="Label Left">
                                <Form
                                    inline
                                    style={{ width: 700 }}
                                    size={getValue('demo1').size.value}
                                >
                                    <FormItem
                                        label={i18n.labels.username}
                                        help={
                                            getValue('demo1').help.value === 'true'
                                                ? i18n.help.username
                                                : null
                                        }
                                    >
                        ...
                        <Demo title="Form Vertical">
                            <DemoGroup label="Normal">
                                <Form
                                    labelAlign="left"
                                    style={{ minWidth: 500 }}
                                    size={getValue('demo2').size.value}
                                >
                                    <FormItem
                                        {...formItemLayout}
                                        label={i18n.labels.username}
                                        help={
                                            getValue('demo2').help.value === 'true'
                                                ? i18n.help.username
                                                : null
                                        }
                                    >
                            ...
                            <DemoGroup label="Label Inset">
                                <Form
                                    labelAlign="inset"
                                    labelTextAlign={getValue('demo2').insetAlign.value}
                                    style={{ minWidth: 500 }}
                                    size={getValue('demo2').size.value}
                                    help={
                                        getValue('demo2').help.value === 'true'
